<?php
	...
	{
		header("location:news_modify_index.php");
	}
?>
...
<header>
	...
	<div class="content" align="center">
        ...
        <div style="position:absolute; left:350px">
            <form action="news_modify_main.php" method="post" enctype="multipart/form-data">
                <div>
                    <span><input type="hidden" name="id" value="<? echo $result['news_id']; ?>"/></span>
                    <span><font>標題</font></span>
                    <span><input type="text" id="title" name="title" size="50" value="<? echo $result['news_title']; ?>" 
                    style="height:27px; font-size:20px" disabled="disabled"/></span>
                </div>
                <br>
                <div>
                    <span><font>日期</font></span>
                    <span><input id="date" name="date" value="<? echo $result['news_date']; ?>" 
                    style="width:175px; text-align:center; font-size:15px"  disabled="disabled"/></span>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span><font>圖片</font></span>
                    <span><input type="file" name="image" id="image" style="font-size:15px; text-align:center"/></span>
                    <span><input id="imgname" value="<? echo $result['news_image']; ?>"
                    style="text-align:center; height:25px; font-size:15px" disabled="disabled"/></span>
                </div>
                <br>
                <div id="example" class="k-content" align="center" style="background-color:transparent">
                    <textarea id="content" name="content" rows="10" cols="30" style="width:740px; height:440px" disabled="disabled">
                    <? echo html_entity_decode($result['news_content']); ?></textarea>
                </div>
                <button type="submit" id="buttonSubmit">送出</button>
                <button type="button" id="buttonMod">修改</button>
